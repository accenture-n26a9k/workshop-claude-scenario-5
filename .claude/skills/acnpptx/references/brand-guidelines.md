...
### Font sizes -- Content slides (white background)
...
### Font sizes -- Cover slides (DARKEST_PURPLE background)
...
> **White-background cover (`cover_text_color: "BLACK"`)**: WHITE / LIGHT_PURPLE text becomes invisible. Use BLACK / TEXT_BODY / MID_GRAY for all text.

- **13pt is forbidden** -- Allowed sizes: 12 / 14 / 18 / 28 / 36-44
- **Minimum**: 12pt (enforced by brand_check.py)
- **Sentence case only** -- ALL CAPS and Title Case are forbidden
